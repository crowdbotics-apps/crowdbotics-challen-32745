...
## Project Structure
    ...
    ├── crowdbotics_challen_32745  # Django project configurations
...
1. Clone this repo and `cd crowdbotics_challen_32745`
...
2. Clone this repo and `cd crowdbotics_challen_32745`
